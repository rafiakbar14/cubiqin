        ...
        <section className="section-container border-t border-[#27272a]">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12 mt-12 opacity-70 hover:opacity-100 transition-opacity">
              {[
                { name: "Next.js", icon: <img src="/assets/branding/nextjs.png" alt="Next.js" className="h-10 md:h-12 w-auto opacity-100 transition-opacity" /> },
                { name: "React", icon: <svg width="50" height="50" viewBox="-11.5 -10.23174 23 20.46348" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="0" cy="0" r="2.05" fill="white" /><g stroke="white" strokeWidth="1" fill="none"><ellipse rx="11" ry="4.2" /><ellipse rx="11" ry="4.2" transform="rotate(60)" /><ellipse rx="11" ry="4.2" transform="rotate(120)" /></g></svg> },
                { name: "Tailwind", icon: <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.001 4.8c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624C13.666 10.618 15.027 12 18.001 12c3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C16.337 6.182 14.976 4.8 12.001 4.8zm-6 7.2c-3.2 0-5.2 1.6-6 4.8 1.2-1.6 2.6-2.2 4.2-1.8.913.228 1.565.89 2.288 1.624 1.177 1.194 2.538 2.576 5.512 2.576 3.2 0 5.2-1.6 6-4.8-1.2 1.6-2.6 2.2-4.2 1.8-.913-.228-1.565-.89-2.288-1.624C10.337 13.382 8.976 12 6.001 12z" fill="white" /></svg> },
                { name: "TypeScript", icon: <svg width="50" height="50" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#3178C6" /><path d="M30 35h30v8h-11v42h-8V43h-11v-8zm55 31.5c0 10-6.5 16.5-16.5 16.5-5.5 0-10-2-13.5-5.5l5-5.5c2.5 2.5 5.5 3.5 8.5 3.5 5.5 0 8-3 8-7.5v-.5c0-4-3-6-8.5-8.5-6.5-3-11.5-6.5-11.5-13.5 0-8.5 6-14.5 14.5-14.5 4.5 0 8.5 1.5 12 4.5l-4.5 6c-2-2-4.5-3-7.5-3-4 0-6.5 2-6.5 5.5v.5c0 3.5 3 5.5 8.5 8 7 3.5 11.5 7.5 11.5 14v1z" fill="white" /></svg> },
                { name: "Vercel", icon: <svg width="50" height="50" viewBox="0 0 76 65" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M37.5274 0L75.0548 65H0L37.5274 0Z" fill="white" /></svg> },
                { name: "Framer Motion", icon: <svg width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0L12 12L24 0H0ZM0 12L12 24V12H0ZM12 12V24L24 12H12Z" fill="white" /></svg> }
              ].map((tech) => (
