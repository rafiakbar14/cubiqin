        ...
        <section className="section-container border-t border-[#27272a]">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12 mt-12 opacity-70 hover:opacity-100 transition-opacity">
              {[
                { name: "Next.js", icon: <svg width="40" height="40" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="64" cy="64" r="64" fill="black" /><path d="M109.685 107.411L51.6811 31.9546H42.7844V101.442H51.4913V50.3168L102.133 115.826C104.793 113.315 107.319 110.505 109.685 107.411Z" fill="white" /><rect x="83.3364" y="31.9546" width="8.60101" height="69.4878" fill="white" /></svg> },
