        ...
        <section className="section-container border-t border-[#27272a]">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-8 md:gap-12 mt-12 opacity-70 hover:opacity-100 transition-opacity">
              {[
                { name: "Next.js", icon: <svg width="80" height="20" viewBox="0 0 283 64" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M141.04 16c-11.04 0-19 7.2-19 18s8.96 18 20 18c6.67 0 12.55-2.64 16.19-7.09l-7.65-4.42c-2.02 2.21-5.09 3.51-8.54 3.51-4.71 0-8.68-2.34-10.03-5.62l33.61-4.01c.06-.58.11-1.17.11-1.77 0-10.8-7.72-16.6-17.51-16.63h.03zm-8.24 14.81c1.1-3.52 4.41-6.19 8.24-6.19 5.86 0 10.02 3.1 10.29 8.24l-18.53 1.95zm-119.55-1.92l43.8 61.8h9.3V.66h-9.3v48.81L21.29.66h-9.3V61.8h9.3V28.89zm149.33 32.91V28.89l-43.8 32.91h-9.3V.66l43.8 32.91h9.3V.66h9.3v61.14h-9.3V28.89zm44.29-37.4l-10-14.81h-10.96l15.47 23.09-15.47 23.09h10.96l10-14.81 10.01 14.81h10.95L210.9 37.09l15.48-23.09h-10.95l-10.01 14.81zm56.09-14.81c3.5 0 6.3 2.8 6.3 6.3s-2.8 6.3-6.3 6.3-6.3-2.8-6.3-6.3 2.8-6.3 6.3-6.3zm0 3.01c-1.8 0-3.3 1.5-3.3 3.3s1.5 3.3 3.3 3.3 3.3-1.5 3.3-3.3c0-1.8-1.5-3.3-3.3-3.3z" fill="white" /></svg> },
                { name: "React", icon: <svg width="40" height="40" viewBox="-11.5 -10.23174 23 20.46348" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="0" cy="0" r="2.05" fill="white" /><g stroke="white" strokeWidth="1" fill="none"><ellipse rx="11" ry="4.2" /><ellipse rx="11" ry="4.2" transform="rotate(60)" /><ellipse rx="11" ry="4.2" transform="rotate(120)" /></g></svg> },
                ...
                { name: "TypeScript", icon: <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#3178C6" /><path d="M30 35h30v8h-11v42h-8V43h-11v-8zm55 31.5c0 10-6.5 16.5-16.5 16.5-5.5 0-10-2-13.5-5.5l5-5.5c2.5 2.5 5.5 3.5 8.5 3.5 5.5 0 8-3 8-7.5v-.5c0-4-3-6-8.5-8.5-6.5-3-11.5-6.5-11.5-13.5 0-8.5 6-14.5 14.5-14.5 4.5 0 8.5 1.5 12 4.5l-4.5 6c-2-2-4.5-3-7.5-3-4 0-6.5 2-6.5 5.5v.5c0 3.5 3 5.5 8.5 8 7 3.5 11.5 7.5 11.5 14v1z" fill="white" /></svg> },
